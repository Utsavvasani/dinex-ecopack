...
export function Footer() {
  return (
    <footer className="w-full bg-primary text-primary-foreground pt-16 pb-8">
      <div className="container px-4 md:px-6 mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 mb-10">
        {/* Column 1: Logo & About */}
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start space-x-3 text-primary-foreground/90">
              ...
              <div className="text-sm text-primary-foreground/70">
                ...
                114, Belmont rise,<br />
                Cheam, London. SM26EE<br />
                <a href="tel:+447879905973" className="hover:text-white transition-colors block mt-1">
                  +44 7879905973
                </a>
              </div>
            </div>
        ...
        {/* Column 3: Get in Touch (Numbers & Socials) */}
        <div className="space-y-6">
          <h4 className="text-xl font-bold border-b border-primary-foreground/20 pb-2 inline-block">
            Get in Touch
          </h4>
